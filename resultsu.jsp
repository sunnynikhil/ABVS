<%-- 
    Document   : resultsu
    Created on : Jun 9, 2019, 7:15:46 PM
    Author     : SunNikhil
--%>
...
<h3 style="color:black">Here are the results your viewing district wise and you can total election result by clicking here <a href="totalresultsu.jsp">Results <a> also</h3>
...
<%
    ...
    %>
    <img src="image/results.png"  style="border: 10px;padding-left: 40px;margin-left: 450px; " name="vote">
    </body>
</html>
