<%-- 
    Document   : updatedb
    Created on : Jun 8, 2019, 6:55:03 PM
    Author     : SunNikhil
--%>
...
String queryString = "SELECT username,password FROM users WHERE username='"+name+"'  AND password='"+key+"';" ;
